...
class MSMT17_V2(object):
    ...
    def preprocess(self, list_file, subpath):
        ...
        for img_idx, img_info in enumerate(lines):
            ...
            data.append((osp.join(subpath, img_path), pid, camid, 3))          # for multi source
            # data.append([img_path, pid, camid, 0])                         # forked from QAConv for single source msmt
    ...
    def load(self):
        ...
        self.train += self.val
        if self.combine_all:
            for item in self.train:                 # item: ('mask_train_v2/0000/0000_045_12_0303morning_0006_2.jpg', 0, 11, 3)
