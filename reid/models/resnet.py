...
class ResNet(nn.Module):
    def __init_with_imagenet(self, baseModel):
        ...
        baseModel.load_state_dict(model.state_dict())

    def getBase(self):
        baseModel = ResNetBase([3, 4, 6, 3])
        self.__init_with_imagenet(baseModel)
        return baseModel


    def __init__(self, num_features=0, dropout=0, cut_at_pooling=False, norm=True, num_classes=[0,0,0], BNNeck=True):
